...
namespace DataPrepper.GenerationRelated
{
    ...
    public class BitmapSubSection
    {
        ...
        public BitmapSubSection(Bitmap incomingBitmap,string bitmapFileName,
            int xPos1, int yPos1,
            int xPos2, int yPos2)
        {
        ...
        /// </param>
        /// <returns></returns>
        public static BitmapSubSection RandomizeSize(Bitmap incomingBitmap, double percentageReductionAmmount, string bitmapName)
        {
            ...
            return new BitmapSubSection(incomingBitmap, bitmapName, xPos1, yPos1, xPos2, yPos2);
        }
    }
}
